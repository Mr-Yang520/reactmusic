...
export default function Reducer(state = intState, action) {
  switch (action.type) {
    case styleTypes.PLAYER_SONGS:
      return state.set('songDetail', action.songDetail)
    case styleTypes.CHNAGE_SONGS_LIST:
      return state.set('playList', action.playList)
    case styleTypes.CHAGE_SONGS_INDEX:
      return state.set('playIndex', action.index)
    case styleTypes.CHNAGE_SEQUENCE:
      return state.set('sequence', action.sequence)
    case styleTypes.CHNAGE_SONG_LYRIC:
